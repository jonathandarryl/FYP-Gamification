...
//    @OneToMany(mappedBy = "storagePost")
//    private List<Bid> bidList;
    
    public StoragePost() {}
                
    public StoragePost(Account account, Long companyId, String title, String content, Double initBid, Timestamp endDateTime, 
            Boolean reservePriceSpecified, Double reservePrice, Boolean vickreyAuctionSpecified, Boolean blindAuctionSpecified, 
            Boolean englishAuctionSpecified, Long warehouseId, Location location, Double capacity, 
    ...
    public String toString() {
        return "GRNS.entity.WarehousePost[ id=" + id + " ]";
    }
