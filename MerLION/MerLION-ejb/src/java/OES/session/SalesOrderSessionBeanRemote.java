...
//    public void updateSalesOrder(Long sqId, Long soId);
    ...
    public void fulfillSalesOrder(Long soId)
            throws SalesOrderNotExistException, SalesOrderAlreadyFulfilledException, SalesOrderFinishedGoodtNotReadyException;
