...
public class Vessel extends Vehicles implements Serializable {
    ...
    public Vessel(String type, Integer useYear, Long capacity, Long maxDistance, Double transCost, Boolean perishable, Boolean flammable, Boolean pharmaceutical, Boolean highvalue, Boolean avail) {
        this.setType(type);
