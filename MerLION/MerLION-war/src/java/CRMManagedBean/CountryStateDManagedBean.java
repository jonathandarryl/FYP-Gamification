...
@ManagedBean (name = "countryStateDManagedBean")
@Named(value = "countryStateDManagedBean")

public class CountryStateDManagedBean implements Serializable {
     ...
     *
     */
    public CountryStateDManagedBean() {
    }
